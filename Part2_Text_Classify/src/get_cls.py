...
def get_text(item):
    ...
    for files in filelist:
        # print (files)
        f = open(base_path + 'data_train/' + item + '/' + files, 'r', encoding='utf-8')
        text = f.read().replace('\n', '')
    ...
    f2 = open('%s.txt' % item, 'a+', encoding='utf-8')
...
def trans_text():
    ...
    f3 = open('id2class2.txt', 'a', encoding='utf-8')
...
def get_classify():
    ...
    for files in filelist2:
        ...
        f = open(base_path + "data_test/" + files, 'r', encoding='utf-8')
